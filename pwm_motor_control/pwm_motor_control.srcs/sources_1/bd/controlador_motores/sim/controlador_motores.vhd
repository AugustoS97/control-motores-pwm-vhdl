...
entity controlador_motores is
  ...
  attribute CORE_GENERATION_INFO of controlador_motores : entity is "controlador_motores,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=controlador_motores,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=5,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=5,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
...
architecture STRUCTURE of controlador_motores is
  ...
  component controlador_motores_control_dir_1_0 is
  port (
    direccion : in STD_LOGIC;
    dir_A : out STD_LOGIC;
    dir_B : out STD_LOGIC
  );
  end component controlador_motores_control_dir_1_0;
  component controlador_motores_pwm_dc_motor_1_0 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
    ce : in STD_LOGIC;
  ...
  end component controlador_motores_pwm_dc_motor_1_0;
  ...
  signal control_dir_1_dir_A : STD_LOGIC;
  signal control_dir_1_dir_B : STD_LOGIC;
...
begin
  ...
  out_2A <= control_dir_1_dir_A;
  out_2B <= control_dir_1_dir_B;
  pwm_drcha <= pwm_dc_motor_0_PWM;
  pwm_izda <= pwm_dc_motor_1_PWM;
  reset_1 <= reset;
...
control_dir_1: component controlador_motores_control_dir_1_0
     port map (
      dir_A => control_dir_1_dir_A,
      dir_B => control_dir_1_dir_B,
...
pwm_dc_motor_1: component controlador_motores_pwm_dc_motor_1_0
     port map (
