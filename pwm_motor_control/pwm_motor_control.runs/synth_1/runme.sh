...
HD_PWD='C:/Users/Augusto/Desktop/Proyecto2_FPGA/pwm_motor_control/pwm_motor_control.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log controlador_motores_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source controlador_motores_wrapper.tcl
