...
HD_PWD='C:/Users/Augusto/Desktop/Proyecto2_FPGA/pwm_motor_control/pwm_motor_control.runs/controlador_motores_control_dir_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log controlador_motores_control_dir_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source controlador_motores_control_dir_1_0.tcl
