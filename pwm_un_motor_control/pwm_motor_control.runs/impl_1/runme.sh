...
HD_PWD='C:/Users/Augusto/Desktop/Proyecto2_FPGA/pwm_motor_control/pwm_motor_control.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log controlador_motores_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source controlador_motores_wrapper.tcl -notrace
