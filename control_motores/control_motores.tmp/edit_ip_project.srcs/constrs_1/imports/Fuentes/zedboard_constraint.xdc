...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {pwm_out}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {OUT1A}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {OUT1B}];  # "LD2"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {IN1A}];  # "BTNC"
set_property PACKAGE_PIN R16 [get_ports {IN1B}];  # "BTND"
set_property PACKAGE_PIN N15 [get_ports {reset}];  # "BTNL"
set_property PACKAGE_PIN R18 [get_ports {ce}];  # "BTNR"
...
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {consigna_speed[0]}];  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {consigna_speed[1]}];  # "SW1"
set_property PACKAGE_PIN H22 [get_ports {consigna_speed[2]}];  # "SW2"
set_property PACKAGE_PIN F21 [get_ports {consigna_speed[3]}];  # "SW3"
set_property PACKAGE_PIN H19 [get_ports {consigna_speed[4]}];  # "SW4"
set_property PACKAGE_PIN H18 [get_ports {consigna_speed[5]}];  # "SW5"
set_property PACKAGE_PIN H17 [get_ports {consigna_speed[6]}];  # "SW6"
set_property PACKAGE_PIN M15 [get_ports {consigna_speed[7]}];  # "SW7"
