...
HD_PWD='c:/users/augusto/desktop/proyecto2_fpga/control_motores/control_motores.tmp/edit_ip_project.runs/control_motor_pwm_dc_motor_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log control_motor_pwm_dc_motor_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source control_motor_pwm_dc_motor_0_0.tcl
