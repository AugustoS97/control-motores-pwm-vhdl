...
HD_PWD='c:/users/augusto/desktop/proyecto2_fpga/control_motores/control_motores.tmp/edit_ip_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log control_motor_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source control_motor_wrapper.tcl -notrace
