...
HD_PWD='c:/users/augusto/desktop/proyecto2_fpga/control_motores/control_motores.tmp/edit_ip_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log control_motor_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source control_motor_wrapper.tcl
