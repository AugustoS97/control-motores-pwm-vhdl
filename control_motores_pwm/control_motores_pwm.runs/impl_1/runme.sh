...
HD_PWD='C:/Users/Augusto/Desktop/Proyecto2_FPGA/control_motores_pwm/control_motores_pwm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log controlador_pwm_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source controlador_pwm_wrapper.tcl -notrace
