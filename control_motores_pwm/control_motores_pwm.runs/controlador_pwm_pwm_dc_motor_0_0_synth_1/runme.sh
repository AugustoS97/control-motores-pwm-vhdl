...
HD_PWD='C:/Users/Augusto/Desktop/Proyecto2_FPGA/control_motores_pwm/control_motores_pwm.runs/controlador_pwm_pwm_dc_motor_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log controlador_pwm_pwm_dc_motor_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source controlador_pwm_pwm_dc_motor_0_0.tcl
