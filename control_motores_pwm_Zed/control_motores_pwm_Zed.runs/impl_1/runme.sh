...
HD_PWD='C:/Users/Augusto/Desktop/Proyecto2_FPGA/control_motores_pwm_Zed/control_motores_pwm_Zed.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log control_motores_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source control_motores_wrapper.tcl -notrace
