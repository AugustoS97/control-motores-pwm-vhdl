...
HD_PWD='C:/Users/Augusto/Desktop/Proyecto2_FPGA/control_motores_pwm_Zed/control_motores_pwm_Zed.runs/control_motores_pwm_dc_motor_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log control_motores_pwm_dc_motor_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source control_motores_pwm_dc_motor_1_0.tcl
