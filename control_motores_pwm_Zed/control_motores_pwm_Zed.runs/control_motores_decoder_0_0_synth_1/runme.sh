...
HD_PWD='C:/Users/Augusto/Desktop/Proyecto2_FPGA/control_motores_pwm_Zed/control_motores_pwm_Zed.runs/control_motores_decoder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log control_motores_decoder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source control_motores_decoder_0_0.tcl
